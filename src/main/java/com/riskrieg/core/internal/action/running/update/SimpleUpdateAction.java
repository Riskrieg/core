...
public final class SimpleUpdateAction implements Action<UpdateBundle> {
  ...
  public SimpleUpdateAction(GameMode gameMode, GameState gameState, GameMap gameMap, Deque<Player> players, Collection<Nation> nations) {
