...
package com.riskrieg.core.old.api.gamemode.regicide;
...
import com.riskrieg.core.old.internal.action.running.claim.RegicideClaimAction;
import com.riskrieg.core.old.internal.action.running.update.RegicideUpdateAction;
import com.riskrieg.core.old.internal.action.setup.FormNationAction;
...
import com.riskrieg.core.old.internal.action.setup.start.StartAction;
...
public final class RegicideMode implements GameMode {
  ...
  public Action<ClaimBundle> claim(Identity identity, TerritoryId... territoryIds) {
    setLastUpdated();
    return new RegicideClaimAction(identity, Set.of(territoryIds), players.getFirst().identity(), gameState, gameMap, nations);
  }
